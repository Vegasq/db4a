...
COMMON_OBJS := build/blocks.o build/hal_stub.o build/hal_vdp.o build/hal_input.o build/mouse.o build/cursor.o build/buildmenu.o build/psg.o build/ym2612.o build/savestate.o \
